package com.simi.pictureselector.service;
...
public class ForegroundService extends Service {
    private static final String CHANNEL_ID = "com.simi.pictureselector" + "." + ForegroundService.class.getName();
    private static final String CHANNEL_NAME = "com.simi.pictureselector";
