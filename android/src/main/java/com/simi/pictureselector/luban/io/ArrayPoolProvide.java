...
import com.simi.pictureselector.luban.io.BufferedInputStreamWrap;
import com.simi.pictureselector.luban.io.LruArrayPool;
...
public class ArrayPoolProvide {
     ...
     * byte[]数组的缓存队列
     */
    private final com.simi.pictureselector.luban.io.LruArrayPool arrayPool = new com.simi.pictureselector.luban.io.LruArrayPool(LruArrayPool.DEFAULT_SIZE);
